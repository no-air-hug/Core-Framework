...
export type BusinessHoursPeriod = {
  ...
  closingTime: Scalars['TimeWithoutTimezone']['input'];
  /** The time that the pickup point location opens. */
  openingTime: Scalars['TimeWithoutTimezone']['input'];
};
...
export type FunctionFetchResult = {
...
export type Input = {
   ...
   * @deprecated Use `deliveryAddress` instead.
   */
...
/** The root mutation for the API. */
export type MutationRootFetchArgs = {
...
export type PickupPoint = {
   ...
   */
  businessHours?: InputMaybe<Array<BusinessHours>>;
...
export type PickupPointDeliveryOption = {
  /**
  ...
  metafields?: InputMaybe<Array<MetafieldOutput>>;
  /**
...
export type FetchInputVariables = Exact<{ [key: string]: never; }>;


export type FetchInput = { __typename?: 'Input', deliveryAddress: { __typename?: 'MailingAddress', countryCode?: CountryCode | null, longitude?: number | null, latitude?: number | null }, cart: { __typename?: 'Cart', cost: { __typename?: 'CartCost', subtotalAmount: { __typename?: 'MoneyV2', amount: any } }, lines: Array<{ __typename?: 'CartLine', quantity: number, merchandise: { __typename?: 'CustomProduct' } | { __typename: 'ProductVariant', id: string, sku?: string | null } }> }, shop: { __typename?: 'Shop', apiUrl?: { __typename?: 'Metafield', value: string } | null, osSalesChannel?: { __typename?: 'Metafield', value: string } | null, osDeliveryMapping?: { __typename?: 'Metafield', value: string } | null } };

export type RunInputVariables = Exact<{ [key: string]: never; }>;


export type RunInput = { __typename?: 'Input', fetchResult?: { __typename?: 'HttpResponse', status: number, body?: string | null } | null };
